var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            description: "The Okapi Wildlife Reserve was established in 1992 to protect the unique way of life of indigenous peoples, wildlife, and the Ituri forest ecosystem. A mixed-use protected area, the Okapi Reserve protects 13,726 sq km (5125 sq mi). This important reserve protects the rights of access to arable land for indigenous Bantu horticulturalist communities as well. <p>In 1996, Okapi Wildlife Reserve was named a UNESCO World Heritage Site, by virtue of it containing the most important and significant natural habitats for in-situ biodiversity conservation of threatened species. The reserve harbors globally important populations of African forest elephant, okapi, and eastern chimpanzees, as well as 12 other species of diurnal and four nocturnal primate species, ranking it as the top protected area in sub-Saharan Africa in terms of primate diversity (17 species in total).",
            location: {
                center: [28.131101, 1.531721],
                zoom: 7.5,
                pitch: 20,
        ...
        },
        {
            ...
            description: "The Reserve contains many small villages, and reserve management has the delicate task of engaging communities in conservation while limiting non-compatible land and resource use. The reserve's history has been marred by spates of militarized elephant poaching, mining, and episodes of armed contact between park guards and militia groups, and the communities within the reserve remain very poor. Land and resource use within the reserve limit human migration and are meant to support subsistence farming and sustainable, discriminate hunting. Despite these policies and strong management, the conservation outlook for the reserve remains critical as it has been retained on the List of World Heritage in Danger by UNESCO since 1997.",
            location: {
                center: [28.131101, 1.531721],
                zoom: 8.5,
                pitch: 30,
        ...
        },
        {
            ...
            // image: './path/to/image/source.png',
            description: "Ituri Province, home to the Okapi Reserve, is renowned for its mineral wealth, particularly gold-bearing belts that have attracted both local and international speculators. Throughout the 2010s, small-scale artisanal mining has posed a persistent challenge in managing the reserve's southwest bloc, with park guards occasionally negotiating to clear thousands of miners from deep forest locations. <p>Since at least 2011, the DRC's Mining Cadastre (CAMI), responsible for allocating mineral prospection licenses, has been using a significantly reduced version of the Reserve's boundaries. This version shrinks the actual size by roughly one-third, moving the western boundary eastwards by over 22 kilometers (14 miles), the northern boundary southwards by over 25 kilometers (16 miles), and the southern boundary northwards by over 12 kilometers (8 miles).",
            location: {
                center: [28.131101, 1.531721],
                zoom: 8.5,
                pitch: 20,
        ...
        },
        {
            ...
            // image: './path/to/image/source.png',
            description: "CAMI's representation of the Okapi Reserve totals just 9,107 sq km, compared to the Reserve's actual area of 13,726.25 sq km according to the <a href='https://www.protectedplanet.net/37043/'> World Database on Protected Areas</a> - a 33% reduction. This discrepancy has led CAMI to award and renew research, exploration, and extraction concessions that technically fall within the Reserve's decreed boundaries. These concessions are particularly prevalent along the Ituri River in the southern part of the reserve and along its western boundary, which follows the 28 deg E parallel from the confluence of the Lenda and Ituri Rivers to the Agamba River.<p>Mining concession data are available on the <a href='http://drclicences.cami.cd/EN/'>DRC Mining Cadastre Map Portal</a>, though CAMI's protected area boundaries data are not publicly accessible. <p><i>*The digitized CAMI representation of the Okapi Reserve boundary appears blocky due to CAMI's practice of conforming concessions to a 30-arc second grid.</i>",
            location: {
                center: [28.131101, 1.531721],
                zoom: 8.5,
                pitch: 20,
