var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            // image: '/assets/rfo_gfw_alerts_confidence.gif',
            description: "In 2022 and beyond, the mining complex appears to have continued to expand. These sites are causing permanent damages to the forest, as well as the Ituri River for citizens downstream. There will undoubtedly need to be extensive restoration efforts and ideally, a stop to all semi-industrial mining, in able to ensure that Okapi Reserve continues to support its wildlife and indigenous peoples.",
            location: {
